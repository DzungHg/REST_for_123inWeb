...
namespace PriceCalcInteral
{
    public class TinhPhi
    {
        public static decimal GiaIn(CauHinhTinhGiaCuon cauHinhTGCuon)
        {
            ...
            ketQua = chiPhiIn +  chiPhiIn * (decimal)mucLoiNhuanIn_TP / (1 - (decimal)mucLoiNhuanIn_TP); 
        ...
        public static decimal PhiIn (CauHinhIn cauHinhIn, int soToChay)
        {
            ...
            var phiVanHanh = cauHinhIn.BHR * (cauHinhIn.ThoiGianChuanBi/60 + thoiGianIn); //Thoi gian chuan bi la Phut
        ...
        {//la
            ...
            var thoiGianCan = dienTichToChay / cauHinhCan.TocDoM2; //M2/gio
